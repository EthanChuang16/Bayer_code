...
outname = os.path.join(sourceDir, 'ADC_ZInc.csv')
...
dfout = pd.DataFrame({'MRN': mrn_arr, 'SeriesNum': seriesNum_arr, 'ManufacturerModelName': mriModel_arr, 'SeriesDescription': mriSeries_arr, 'nslice': nslice_arr, 'zpos': z_possslice_arr, 'increassing_ct': increasing_ct_arr, 'decreasing_ct': decreasing_ct_arr})
